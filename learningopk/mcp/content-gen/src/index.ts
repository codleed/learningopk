    ...
    tools: [
      {
        name: "generate_quiz",
        description:
          "Generate board-aligned MCQs, short questions, and fill-in-blanks from chapter curriculum data",
        inputSchema: {
          type: "object",
          properties: {
            ...
            types: {
              type: "array",
              items: { type: "string", enum: ["mcq", "short", "fill_in_blanks"] },
            },
            ...
            text: JSON.stringify(
              {
                ...
                questions: Array.from({ length: args.questionCount }, (_, i) => ({
                  ...
                  options:
                    args.types[i % args.types.length] === "mcq" ? ["A", "B", "C", "D"] : undefined,
                  answer: "A",
                })),
              },
              null,
