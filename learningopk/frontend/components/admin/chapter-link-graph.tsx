...
export function ChapterLinkGraph({ nodes, edges, activeChapterId, onOpenChapter }: ChapterLinkGraphProps) {
  ...
  return (
    <div ref={containerRef} className="w-full overflow-hidden rounded-lg border border-border/60 bg-background p-1">
      <ForceGraph2D
        width={size.width}
        height={size.height}
        graphData={graphData}
